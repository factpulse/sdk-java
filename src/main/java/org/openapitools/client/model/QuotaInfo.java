...
public class QuotaInfo {
  ...
  public QuotaInfo limit(@javax.annotation.Nonnull Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public QuotaInfo usage(@javax.annotation.Nonnull Integer usage) {
    this.usage = usage;
    return this;
  }
  ...
  public void setUsage(@javax.annotation.Nonnull Integer usage) {
    this.usage = usage;
  }


  public QuotaInfo remaining(@javax.annotation.Nonnull Integer remaining) {
  ...
  public QuotaInfo resetDate(@javax.annotation.Nonnull String resetDate) {
  ...
  public QuotaInfo plan(@javax.annotation.Nonnull String plan) {
    this.plan = plan;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.limit, quotaInfo.limit) &&
        Objects.equals(this.usage, quotaInfo.usage) &&
        Objects.equals(this.remaining, quotaInfo.remaining) &&
        Objects.equals(this.resetDate, quotaInfo.resetDate) &&
        Objects.equals(this.plan, quotaInfo.plan);
  }

  @Override
  public int hashCode() {
    return Objects.hash(limit, usage, remaining, resetDate, plan);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("limit", "usage", "remaining", "reset_date", "plan"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("limit", "usage", "remaining", "reset_date", "plan"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QuotaInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in QuotaInfo is not found in the empty JSON string", QuotaInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QuotaInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `QuotaInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : QuotaInfo.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("reset_date").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `reset_date` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reset_date").toString()));
      }
