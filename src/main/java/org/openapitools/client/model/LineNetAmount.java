...
public class LineNetAmount extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!LineNetAmount.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'LineNetAmount' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<LineNetAmount>() {
                @Override
                public void write(JsonWriter out, LineNetAmount value) throws IOException {
                ...
                @Override
                public LineNetAmount read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        LineNetAmount ret = new LineNetAmount();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for LineNetAmount: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to LineNetAmount
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for LineNetAmount with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of LineNetAmount given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of LineNetAmount
     * @throws IOException if the JSON string is invalid with respect to LineNetAmount
     */
    public static LineNetAmount fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, LineNetAmount.class);
    }

    /**
     * Convert an instance of LineNetAmount to an JSON string
     *
     * @return JSON string
     */
