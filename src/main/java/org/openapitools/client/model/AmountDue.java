...
public class AmountDue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AmountDue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AmountDue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AmountDue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<AmountDue>() {
                @Override
                public void write(JsonWriter out, AmountDue value) throws IOException {
                ...
                @Override
                public AmountDue read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for AmountDue: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to AmountDue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for AmountDue with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of AmountDue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AmountDue
     * @throws IOException if the JSON string is invalid with respect to AmountDue
     */
    public static AmountDue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AmountDue.class);
    }

    /**
     * Convert an instance of AmountDue to an JSON string
     *
     * @return JSON string
     */
