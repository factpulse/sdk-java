...
public enum CodeRaisonReduction {
  ...
  CodeRaisonReduction(String value) {
    this.value = value;
  }
  ...
  public static CodeRaisonReduction fromValue(String value) {
    for (CodeRaisonReduction b : CodeRaisonReduction.values()) {
  ...
  public static class Adapter extends TypeAdapter<CodeRaisonReduction> {
    @Override
    public void write(final JsonWriter jsonWriter, final CodeRaisonReduction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CodeRaisonReduction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CodeRaisonReduction.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CodeRaisonReduction.fromValue(value);
  }
}
