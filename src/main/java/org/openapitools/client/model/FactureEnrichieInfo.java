  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FactureEnrichieInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FactureEnrichieInfo is not found in the empty JSON string", FactureEnrichieInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FactureEnrichieInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FactureEnrichieInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("nom_emetteur").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `nom_emetteur` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nom_emetteur").toString()));
      }
      if (!jsonObj.get("nom_destinataire").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `nom_destinataire` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nom_destinataire").toString()));
      }
      if (!jsonObj.get("montant_ht_total").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `montant_ht_total` to be a primitive type in the JSON string but got `%s`", jsonObj.get("montant_ht_total").toString()));
      }
