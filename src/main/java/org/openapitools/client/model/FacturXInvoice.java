...
public class FacturXInvoice {
  ...
  @javax.annotation.Nullable
  private SubmissionMode submissionMode = SubmissionMode.DEPOT_PDF_API;
  ...
  public FacturXInvoice submissionMode(@javax.annotation.Nullable SubmissionMode submissionMode) {
  ...
  public void setSubmissionMode(@javax.annotation.Nullable SubmissionMode submissionMode) {
    this.submissionMode = submissionMode;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `submission_mode`
      if (jsonObj.get("submission_mode") != null && !jsonObj.get("submission_mode").isJsonNull()) {
