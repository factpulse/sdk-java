...
public class BaseAmount extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BaseAmount.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!BaseAmount.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'BaseAmount' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<BaseAmount>() {
                @Override
                public void write(JsonWriter out, BaseAmount value) throws IOException {
                ...
                @Override
                public BaseAmount read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for BaseAmount: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to BaseAmount
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for BaseAmount with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of BaseAmount given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of BaseAmount
     * @throws IOException if the JSON string is invalid with respect to BaseAmount
     */
    public static BaseAmount fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, BaseAmount.class);
    }

    /**
     * Convert an instance of BaseAmount to an JSON string
     *
     * @return JSON string
     */
