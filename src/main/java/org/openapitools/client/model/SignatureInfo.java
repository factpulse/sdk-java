...
public class SignatureInfo {
  ...
  public SignatureInfo signe(@javax.annotation.Nonnull Boolean signe) {
    this.signe = signe;
    return this;
  }
  ...
  public void setSigne(@javax.annotation.Nonnull Boolean signe) {
    this.signe = signe;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.signe, signatureInfo.signe) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(signe, cn, expiration);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("signe", "cn", "expiration"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("signe"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SignatureInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SignatureInfo is not found in the empty JSON string", SignatureInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SignatureInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SignatureInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("expiration") != null && !jsonObj.get("expiration").isJsonNull()) && !jsonObj.get("expiration").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `expiration` to be a primitive type in the JSON string but got `%s`", jsonObj.get("expiration").toString()));
      }
  }
