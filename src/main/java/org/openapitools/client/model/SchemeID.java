...
public enum SchemeID {
  ...
  public static SchemeID fromValue(String value) {
    for (SchemeID b : SchemeID.values()) {
  ...
  public static class Adapter extends TypeAdapter<SchemeID> {
    @Override
    public void write(final JsonWriter jsonWriter, final SchemeID enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SchemeID read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SchemeID.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SchemeID.fromValue(value);
  }
}
