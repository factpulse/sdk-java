  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdressePostale.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AdressePostale is not found in the empty JSON string", AdressePostale.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdressePostale.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AdressePostale` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("codePostal") != null && !jsonObj.get("codePostal").isJsonNull()) && !jsonObj.get("codePostal").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `codePostal` to be a primitive type in the JSON string but got `%s`", jsonObj.get("codePostal").toString()));
      }
      if ((jsonObj.get("ligneUn") != null && !jsonObj.get("ligneUn").isJsonNull()) && !jsonObj.get("ligneUn").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `ligneUn` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ligneUn").toString()));
      }
      if ((jsonObj.get("ligneDeux") != null && !jsonObj.get("ligneDeux").isJsonNull()) && !jsonObj.get("ligneDeux").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `ligneDeux` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ligneDeux").toString()));
      }
      if ((jsonObj.get("nomVille") != null && !jsonObj.get("nomVille").isJsonNull()) && !jsonObj.get("nomVille").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `nomVille` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nomVille").toString()));
      }
      if ((jsonObj.get("paysCodeIso") != null && !jsonObj.get("paysCodeIso").isJsonNull()) && !jsonObj.get("paysCodeIso").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `paysCodeIso` to be a primitive type in the JSON string but got `%s`", jsonObj.get("paysCodeIso").toString()));
      }
  }
