...
public enum TypeFacture {
  ...
  public static TypeFacture fromValue(String value) {
    for (TypeFacture b : TypeFacture.values()) {
  ...
  public static class Adapter extends TypeAdapter<TypeFacture> {
    @Override
    public void write(final JsonWriter jsonWriter, final TypeFacture enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TypeFacture read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TypeFacture.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TypeFacture.fromValue(value);
  }
}
