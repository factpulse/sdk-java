...
public enum PaymentMeans {
  ...
  public static class Adapter extends TypeAdapter<PaymentMeans> {
    @Override
    public void write(final JsonWriter jsonWriter, final PaymentMeans enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PaymentMeans read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PaymentMeans.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PaymentMeans.fromValue(value);
  }
}
