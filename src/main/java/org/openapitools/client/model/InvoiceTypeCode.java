 ...
 */
@JsonAdapter(InvoiceTypeCode.Adapter.class)
public enum InvoiceTypeCode {
  ...
  public static InvoiceTypeCode fromValue(String value) {
    for (InvoiceTypeCode b : InvoiceTypeCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<InvoiceTypeCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final InvoiceTypeCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public InvoiceTypeCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return InvoiceTypeCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    InvoiceTypeCode.fromValue(value);
  }
}
