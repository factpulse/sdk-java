...
public class EncaisseeRequest {
  ...
  public EncaisseeRequest invoiceId(@javax.annotation.Nonnull String invoiceId) {
  ...
  public EncaisseeRequest invoiceIssueDate(@javax.annotation.Nonnull LocalDate invoiceIssueDate) {
  ...
  public EncaisseeRequest flowType(@javax.annotation.Nullable String flowType) {
  ...
  public EncaisseeRequest pdpFlowServiceUrl(@javax.annotation.Nullable String pdpFlowServiceUrl) {
  ...
  public EncaisseeRequest pdpTokenUrl(@javax.annotation.Nullable String pdpTokenUrl) {
  ...
  public EncaisseeRequest pdpClientId(@javax.annotation.Nullable String pdpClientId) {
  ...
  public EncaisseeRequest pdpClientSecret(@javax.annotation.Nullable String pdpClientSecret) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to EncaisseeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EncaisseeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EncaisseeRequest is not found in the empty JSON string", EncaisseeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EncaisseeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EncaisseeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EncaisseeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EncaisseeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EncaisseeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EncaisseeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EncaisseeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EncaisseeRequest>() {
           @Override
           public void write(JsonWriter out, EncaisseeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EncaisseeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EncaisseeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EncaisseeRequest
   * @throws IOException if the JSON string is invalid with respect to EncaisseeRequest
   */
  public static EncaisseeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EncaisseeRequest.class);
  }

  /**
   * Convert an instance of EncaisseeRequest to an JSON string
   *
   * @return JSON string
   */
