...
public class Taxamount extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Taxamount.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Taxamount.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Taxamount' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Taxamount>() {
                @Override
                public void write(JsonWriter out, Taxamount value) throws IOException {
                ...
                @Override
                public Taxamount read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for Taxamount: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Taxamount
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for Taxamount with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Taxamount given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Taxamount
     * @throws IOException if the JSON string is invalid with respect to Taxamount
     */
    public static Taxamount fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Taxamount.class);
    }

    /**
     * Convert an instance of Taxamount to an JSON string
     *
     * @return JSON string
     */
