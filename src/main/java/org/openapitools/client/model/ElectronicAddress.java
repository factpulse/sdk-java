...
public class ElectronicAddress {
  ...
  public ElectronicAddress identifier(@javax.annotation.Nonnull String identifier) {
  ...
  public ElectronicAddress schemeId(@javax.annotation.Nullable SchemeID schemeId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, electronicAddress.identifier) &&
        Objects.equals(this.schemeId, electronicAddress.schemeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identifier, schemeId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("identifier", "schemeId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("identifier"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ElectronicAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ElectronicAddress is not found in the empty JSON string", ElectronicAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ElectronicAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ElectronicAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
