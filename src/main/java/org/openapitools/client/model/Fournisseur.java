...
public class Fournisseur {
  ...
  public static final String SERIALIZED_NAME_ID_FOURNISSEUR = "idFournisseur";
  @SerializedName(SERIALIZED_NAME_ID_FOURNISSEUR)
  @javax.annotation.Nonnull
  private Integer idFournisseur;

  public static final String SERIALIZED_NAME_CODE_COORDONNEES_BANCAIRES_FOURNISSEUR = "codeCoordonneesBancairesFournisseur";
  @SerializedName(SERIALIZED_NAME_CODE_COORDONNEES_BANCAIRES_FOURNISSEUR)
  @javax.annotation.Nullable
  private Integer codeCoordonneesBancairesFournisseur;

  public static final String SERIALIZED_NAME_ID_SERVICE_FOURNISSEUR = "idServiceFournisseur";
  @SerializedName(SERIALIZED_NAME_ID_SERVICE_FOURNISSEUR)
  @javax.annotation.Nullable
  private Integer idServiceFournisseur;
  ...
  public static final String SERIALIZED_NAME_NUMERO_TVA_INTRA = "numeroTvaIntra";
  ...
  public Fournisseur adresseElectronique(@javax.annotation.Nonnull AdresseElectronique adresseElectronique) {
  ...
  public Fournisseur idFournisseur(@javax.annotation.Nonnull Integer idFournisseur) {
  ...
  public void setIdFournisseur(@javax.annotation.Nonnull Integer idFournisseur) {
    this.idFournisseur = idFournisseur;
  }


  public Fournisseur codeCoordonneesBancairesFournisseur(@javax.annotation.Nullable Integer codeCoordonneesBancairesFournisseur) {
    this.codeCoordonneesBancairesFournisseur = codeCoordonneesBancairesFournisseur;
    return this;
  }

  /**
   * Get codeCoordonneesBancairesFournisseur
   * @return codeCoordonneesBancairesFournisseur
   */
  @javax.annotation.Nullable
  public Integer getCodeCoordonneesBancairesFournisseur() {
    return codeCoordonneesBancairesFournisseur;
  }

  public void setCodeCoordonneesBancairesFournisseur(@javax.annotation.Nullable Integer codeCoordonneesBancairesFournisseur) {
    this.codeCoordonneesBancairesFournisseur = codeCoordonneesBancairesFournisseur;
  }


  public Fournisseur idServiceFournisseur(@javax.annotation.Nullable Integer idServiceFournisseur) {
    this.idServiceFournisseur = idServiceFournisseur;
    return this;
  }

  /**
   * Get idServiceFournisseur
   * @return idServiceFournisseur
   */
  @javax.annotation.Nullable
  public Integer getIdServiceFournisseur() {
    return idServiceFournisseur;
  }

  public void setIdServiceFournisseur(@javax.annotation.Nullable Integer idServiceFournisseur) {
    this.idServiceFournisseur = idServiceFournisseur;
  }


  public Fournisseur nom(@javax.annotation.Nullable String nom) {
    this.nom = nom;
    return this;
  }
  ...
  public Fournisseur numeroTvaIntra(@javax.annotation.Nullable String numeroTvaIntra) {
  ...
  public Fournisseur iban(@javax.annotation.Nullable String iban) {
    this.iban = iban;
    return this;
  }
  ...
  public Fournisseur adressePostale(@javax.annotation.Nullable AdressePostale adressePostale) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adresseElectronique, fournisseur.adresseElectronique) &&
        Objects.equals(this.idFournisseur, fournisseur.idFournisseur) &&
        ...
        Objects.equals(this.adressePostale, fournisseur.adressePostale);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Fournisseur
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Fournisseur.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Fournisseur is not found in the empty JSON string", Fournisseur.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Fournisseur.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Fournisseur` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Fournisseur.openapiRequiredFields) {
      ...
      if ((jsonObj.get("numeroTvaIntra") != null && !jsonObj.get("numeroTvaIntra").isJsonNull()) && !jsonObj.get("numeroTvaIntra").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `numeroTvaIntra` to be a primitive type in the JSON string but got `%s`", jsonObj.get("numeroTvaIntra").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Fournisseur.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Fournisseur' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Fournisseur> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Fournisseur.class));

       return (TypeAdapter<T>) new TypeAdapter<Fournisseur>() {
           @Override
           public void write(JsonWriter out, Fournisseur value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Fournisseur read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Fournisseur given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Fournisseur
   * @throws IOException if the JSON string is invalid with respect to Fournisseur
   */
  public static Fournisseur fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Fournisseur.class);
  }

  /**
   * Convert an instance of Fournisseur to an JSON string
   *
   * @return JSON string
   */
