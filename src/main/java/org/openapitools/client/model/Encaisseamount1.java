...
public class Encaisseamount1 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Encaisseamount1.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Encaisseamount1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Encaisseamount1' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Encaisseamount1>() {
                @Override
                public void write(JsonWriter out, Encaisseamount1 value) throws IOException {
                ...
                @Override
                public Encaisseamount1 read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        Encaisseamount1 ret = new Encaisseamount1();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for Encaisseamount1: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public Encaisseamount1() {
        super("anyOf", Boolean.TRUE);
    }

    public Encaisseamount1(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return Encaisseamount1.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Encaisseamount1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for Encaisseamount1 with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Encaisseamount1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Encaisseamount1
     * @throws IOException if the JSON string is invalid with respect to Encaisseamount1
     */
    public static Encaisseamount1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Encaisseamount1.class);
    }

    /**
     * Convert an instance of Encaisseamount1 to an JSON string
     *
     * @return JSON string
     */
