 ...
 */
@JsonAdapter(LineSubType.Adapter.class)
public enum LineSubType {
  ...
  public static LineSubType fromValue(String value) {
    for (LineSubType b : LineSubType.values()) {
  ...
  public static class Adapter extends TypeAdapter<LineSubType> {
    @Override
    public void write(final JsonWriter jsonWriter, final LineSubType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LineSubType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LineSubType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LineSubType.fromValue(value);
  }
}
