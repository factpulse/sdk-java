...
public class Rate1 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Rate1.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Rate1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Rate1' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Rate1>() {
                @Override
                public void write(JsonWriter out, Rate1 value) throws IOException {
                ...
                @Override
                public Rate1 read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for Rate1: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Rate1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for Rate1 with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Rate1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Rate1
     * @throws IOException if the JSON string is invalid with respect to Rate1
     */
    public static Rate1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Rate1.class);
    }

    /**
     * Convert an instance of Rate1 to an JSON string
     *
     * @return JSON string
     */
