...
public class AFNORFullFlowInfo {
  ...
  public AFNORFullFlowInfo processingRule(@javax.annotation.Nullable AFNORProcessingRule processingRule) {
  ...
  public AFNORFullFlowInfo flowSyntax(@javax.annotation.Nonnull AFNORFlowSyntax flowSyntax) {
  ...
  public AFNORFullFlowInfo flowProfile(@javax.annotation.Nullable AFNORFlowProfile flowProfile) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AFNORFullFlowInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AFNORFullFlowInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AFNORFullFlowInfo is not found in the empty JSON string", AFNORFullFlowInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AFNORFullFlowInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AFNORFullFlowInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AFNORFullFlowInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AFNORFullFlowInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AFNORFullFlowInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AFNORFullFlowInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AFNORFullFlowInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AFNORFullFlowInfo>() {
           @Override
           public void write(JsonWriter out, AFNORFullFlowInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AFNORFullFlowInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AFNORFullFlowInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AFNORFullFlowInfo
   * @throws IOException if the JSON string is invalid with respect to AFNORFullFlowInfo
   */
  public static AFNORFullFlowInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AFNORFullFlowInfo.class);
  }

  /**
   * Convert an instance of AFNORFullFlowInfo to an JSON string
   *
   * @return JSON string
   */
