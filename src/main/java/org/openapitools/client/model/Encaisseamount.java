...
public class Encaisseamount extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Encaisseamount.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Encaisseamount.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Encaisseamount' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Encaisseamount>() {
                @Override
                public void write(JsonWriter out, Encaisseamount value) throws IOException {
                ...
                @Override
                public Encaisseamount read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        Encaisseamount ret = new Encaisseamount();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for Encaisseamount: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public Encaisseamount() {
        super("anyOf", Boolean.TRUE);
    }

    public Encaisseamount(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Encaisseamount
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for Encaisseamount with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Encaisseamount given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Encaisseamount
     * @throws IOException if the JSON string is invalid with respect to Encaisseamount
     */
    public static Encaisseamount fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Encaisseamount.class);
    }

    /**
     * Convert an instance of Encaisseamount to an JSON string
     *
     * @return JSON string
     */
