...
public class AFNORFacilityPayloadIncluded {
  ...
  public AFNORFacilityPayloadIncluded() {
  }

  public AFNORFacilityPayloadIncluded siret(@javax.annotation.Nullable String siret) {
    this.siret = siret;
    return this;
  }
  ...
  public AFNORFacilityPayloadIncluded siren(@javax.annotation.Nullable String siren) {
    this.siren = siren;
    return this;
  }
  ...
  public AFNORFacilityPayloadIncluded name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AFNORFacilityPayloadIncluded facilityType(@javax.annotation.Nullable AFNORFacilityType facilityType) {
  ...
  public AFNORFacilityPayloadIncluded address(@javax.annotation.Nullable AFNORAddressRead address) {
  ...
  public AFNORFacilityPayloadIncluded b2gAdditionalData(@javax.annotation.Nullable AFNORFacilityPayloadHistoryUleB2gAdditionalData b2gAdditionalData) {
  ...
  public boolean equals(Object o) {
    ...
    AFNORFacilityPayloadIncluded afNORFacilityPayloadIncluded = (AFNORFacilityPayloadIncluded) o;
    return Objects.equals(this.siret, afNORFacilityPayloadIncluded.siret) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to AFNORFacilityPayloadIncluded
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AFNORFacilityPayloadIncluded.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AFNORFacilityPayloadIncluded is not found in the empty JSON string", AFNORFacilityPayloadIncluded.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AFNORFacilityPayloadIncluded.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AFNORFacilityPayloadIncluded` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AFNORFacilityPayloadIncluded.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AFNORFacilityPayloadIncluded' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AFNORFacilityPayloadIncluded> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AFNORFacilityPayloadIncluded.class));

       return (TypeAdapter<T>) new TypeAdapter<AFNORFacilityPayloadIncluded>() {
           @Override
           public void write(JsonWriter out, AFNORFacilityPayloadIncluded value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AFNORFacilityPayloadIncluded read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AFNORFacilityPayloadIncluded given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AFNORFacilityPayloadIncluded
   * @throws IOException if the JSON string is invalid with respect to AFNORFacilityPayloadIncluded
   */
  public static AFNORFacilityPayloadIncluded fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AFNORFacilityPayloadIncluded.class);
  }

  /**
   * Convert an instance of AFNORFacilityPayloadIncluded to an JSON string
   *
   * @return JSON string
   */
