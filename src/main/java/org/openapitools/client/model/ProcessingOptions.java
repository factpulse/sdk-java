...
public class ProcessingOptions {
  ...
  @javax.annotation.Nullable
  private Boolean verifyDestinationParameters = true;
  ...
  public ProcessingOptions autoEnrich(@javax.annotation.Nullable Boolean autoEnrich) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getAutoEnrich() {
    return autoEnrich;
  }

  public void setAutoEnrich(@javax.annotation.Nullable Boolean autoEnrich) {
    this.autoEnrich = autoEnrich;
  }
  ...
  public ProcessingOptions verifyDestinationParameters(@javax.annotation.Nullable Boolean verifyDestinationParameters) {
   ...
   * @return verifyDestinationParameters
   */
  @javax.annotation.Nullable
  public Boolean getVerifyDestinationParameters() {
    return verifyDestinationParameters;
  }

  public void setVerifyDestinationParameters(@javax.annotation.Nullable Boolean verifyDestinationParameters) {
    this.verifyDestinationParameters = verifyDestinationParameters;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProcessingOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProcessingOptions is not found in the empty JSON string", ProcessingOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProcessingOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProcessingOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
