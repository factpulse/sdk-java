...
public class MontantTtcTotal1 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(MontantTtcTotal1.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!MontantTtcTotal1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'MontantTtcTotal1' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<MontantTtcTotal1>() {
                @Override
                public void write(JsonWriter out, MontantTtcTotal1 value) throws IOException {
                ...
                @Override
                public MontantTtcTotal1 read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        MontantTtcTotal1 ret = new MontantTtcTotal1();
                    ...
                    throw new IOException(String.format(Locale.ROOT, "Failed deserialization for MontantTtcTotal1: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public MontantTtcTotal1() {
        super("anyOf", Boolean.FALSE);
    }

    public MontantTtcTotal1(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return MontantTtcTotal1.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to MontantTtcTotal1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(Locale.ROOT, "The JSON string is invalid for MontantTtcTotal1 with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of MontantTtcTotal1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of MontantTtcTotal1
     * @throws IOException if the JSON string is invalid with respect to MontantTtcTotal1
     */
    public static MontantTtcTotal1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, MontantTtcTotal1.class);
    }

    /**
     * Convert an instance of MontantTtcTotal1 to an JSON string
     *
     * @return JSON string
     */
