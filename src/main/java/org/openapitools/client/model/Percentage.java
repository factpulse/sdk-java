...
public class Percentage extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Percentage.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Percentage.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Percentage' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Percentage>() {
                @Override
                public void write(JsonWriter out, Percentage value) throws IOException {
                ...
                public Percentage read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for Percentage: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Percentage
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for Percentage with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Percentage given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Percentage
     * @throws IOException if the JSON string is invalid with respect to Percentage
     */
    public static Percentage fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Percentage.class);
    }

    /**
     * Convert an instance of Percentage to an JSON string
     *
     * @return JSON string
     */
