...
public class FactureEnrichieInfoInput {
  ...
  public FactureEnrichieInfoInput() {
  }

  public FactureEnrichieInfoInput numeroFacture(@javax.annotation.Nonnull String numeroFacture) {
  ...
  public FactureEnrichieInfoInput idEmetteur(@javax.annotation.Nullable Integer idEmetteur) {
  ...
  public FactureEnrichieInfoInput idDestinataire(@javax.annotation.Nullable Integer idDestinataire) {
  ...
  public FactureEnrichieInfoInput nomEmetteur(@javax.annotation.Nonnull String nomEmetteur) {
  ...
  public FactureEnrichieInfoInput nomDestinataire(@javax.annotation.Nonnull String nomDestinataire) {
  ...
  public FactureEnrichieInfoInput montantHtTotal(@javax.annotation.Nonnull MontantHtTotal montantHtTotal) {
  ...
  public FactureEnrichieInfoInput montantTva(@javax.annotation.Nonnull MontantTva montantTva) {
  ...
  public FactureEnrichieInfoInput montantTtcTotal(@javax.annotation.Nonnull MontantTtcTotal montantTtcTotal) {
  ...
  public boolean equals(Object o) {
    ...
    FactureEnrichieInfoInput factureEnrichieInfoInput = (FactureEnrichieInfoInput) o;
    return Objects.equals(this.numeroFacture, factureEnrichieInfoInput.numeroFacture) &&
        Objects.equals(this.idEmetteur, factureEnrichieInfoInput.idEmetteur) &&
        Objects.equals(this.idDestinataire, factureEnrichieInfoInput.idDestinataire) &&
        Objects.equals(this.nomEmetteur, factureEnrichieInfoInput.nomEmetteur) &&
        Objects.equals(this.nomDestinataire, factureEnrichieInfoInput.nomDestinataire) &&
        Objects.equals(this.montantHtTotal, factureEnrichieInfoInput.montantHtTotal) &&
        Objects.equals(this.montantTva, factureEnrichieInfoInput.montantTva) &&
        Objects.equals(this.montantTtcTotal, factureEnrichieInfoInput.montantTtcTotal);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FactureEnrichieInfoInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FactureEnrichieInfoInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in FactureEnrichieInfoInput is not found in the empty JSON string", FactureEnrichieInfoInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FactureEnrichieInfoInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FactureEnrichieInfoInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FactureEnrichieInfoInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FactureEnrichieInfoInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FactureEnrichieInfoInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FactureEnrichieInfoInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FactureEnrichieInfoInput.class));

       return (TypeAdapter<T>) new TypeAdapter<FactureEnrichieInfoInput>() {
           @Override
           public void write(JsonWriter out, FactureEnrichieInfoInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FactureEnrichieInfoInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FactureEnrichieInfoInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FactureEnrichieInfoInput
   * @throws IOException if the JSON string is invalid with respect to FactureEnrichieInfoInput
   */
  public static FactureEnrichieInfoInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FactureEnrichieInfoInput.class);
  }

  /**
   * Convert an instance of FactureEnrichieInfoInput to an JSON string
   *
   * @return JSON string
   */
