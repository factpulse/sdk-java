...
public class AFNORCoreFlowInfo {
  ...
  public AFNORCoreFlowInfo() {
  }

  public AFNORCoreFlowInfo trackingId(@javax.annotation.Nullable String trackingId) {
  ...
  public AFNORCoreFlowInfo name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AFNORCoreFlowInfo processingRule(@javax.annotation.Nullable AFNORProcessingRule processingRule) {
  ...
  public AFNORCoreFlowInfo flowSyntax(@javax.annotation.Nonnull AFNORFlowSyntax flowSyntax) {
  ...
  public AFNORCoreFlowInfo flowProfile(@javax.annotation.Nullable AFNORFlowProfile flowProfile) {
  ...
  public boolean equals(Object o) {
    ...
    AFNORCoreFlowInfo afNORCoreFlowInfo = (AFNORCoreFlowInfo) o;
    return Objects.equals(this.trackingId, afNORCoreFlowInfo.trackingId) &&
        Objects.equals(this.name, afNORCoreFlowInfo.name) &&
        Objects.equals(this.processingRule, afNORCoreFlowInfo.processingRule) &&
        Objects.equals(this.flowSyntax, afNORCoreFlowInfo.flowSyntax) &&
        Objects.equals(this.flowProfile, afNORCoreFlowInfo.flowProfile);
  }
  ...
  public String toString() {
    ...
    sb.append("class AFNORCoreFlowInfo {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("trackingId", "name", "processingRule", "flowSyntax", "flowProfile"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AFNORCoreFlowInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AFNORCoreFlowInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AFNORCoreFlowInfo is not found in the empty JSON string", AFNORCoreFlowInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AFNORCoreFlowInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AFNORCoreFlowInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AFNORCoreFlowInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AFNORCoreFlowInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AFNORCoreFlowInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AFNORCoreFlowInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AFNORCoreFlowInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AFNORCoreFlowInfo>() {
           @Override
           public void write(JsonWriter out, AFNORCoreFlowInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AFNORCoreFlowInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AFNORCoreFlowInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AFNORCoreFlowInfo
   * @throws IOException if the JSON string is invalid with respect to AFNORCoreFlowInfo
   */
  public static AFNORCoreFlowInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AFNORCoreFlowInfo.class);
  }

  /**
   * Convert an instance of AFNORCoreFlowInfo to an JSON string
   *
   * @return JSON string
   */
