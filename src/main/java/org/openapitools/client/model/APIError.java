...
import org.openapitools.client.model.ValidationErrorDetail;
...
public class APIError {
  ...
  public APIError errorCode(@javax.annotation.Nonnull String errorCode) {
  ...
  public APIError errorMessage(@javax.annotation.Nonnull String errorMessage) {
  ...
  public APIError details(@javax.annotation.Nullable List<ValidationErrorDetail> details) {
    this.details = details;
    return this;
  }

  public APIError addDetailsItem(ValidationErrorDetail detailsItem) {
  ...
  public void setDetails(@javax.annotation.Nullable List<ValidationErrorDetail> details) {
    this.details = details;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("errorCode", "errorMessage", "details"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APIError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in APIError is not found in the empty JSON string", APIError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!APIError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `APIError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("details") != null && !jsonObj.get("details").isJsonNull()) {
        ...
        if (jsonArraydetails != null) {
          ...
          for (int i = 0; i < jsonArraydetails.size(); i++) {
            ValidationErrorDetail.validateJsonElement(jsonArraydetails.get(i));
          };
        }
      }
  }
