...
public class VatRate extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(VatRate.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!VatRate.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'VatRate' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<VatRate>() {
                @Override
                public void write(JsonWriter out, VatRate value) throws IOException {
                ...
                @Override
                public VatRate read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for VatRate: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to VatRate
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for VatRate with anyOf schemas: BigDecimal, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of VatRate given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of VatRate
     * @throws IOException if the JSON string is invalid with respect to VatRate
     */
    public static VatRate fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, VatRate.class);
    }

    /**
     * Convert an instance of VatRate to an JSON string
     *
     * @return JSON string
     */
