 ...
 */
@JsonAdapter(TransactionCategory.Adapter.class)
public enum TransactionCategory {
  ...
  public static class Adapter extends TypeAdapter<TransactionCategory> {
    @Override
    public void write(final JsonWriter jsonWriter, final TransactionCategory enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TransactionCategory read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TransactionCategory.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TransactionCategory.fromValue(value);
  }
}
