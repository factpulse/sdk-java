...
public class TraitementFactureApi {
     ...
     * @param profil Profil Factur-X : MINIMUM, BASIC, EN16931 ou EXTENDED. (optional, default to EXTENDED)
     * @param formatSortie Format de sortie : &#39;xml&#39; (XML seul) ou &#39;pdf&#39; (PDF Factur-X avec XML embarqué). (optional, default to xml)
     ...
     * @param profil Profil de validation (MINIMUM, BASIC, EN16931, EXTENDED). (optional, default to EXTENDED)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
