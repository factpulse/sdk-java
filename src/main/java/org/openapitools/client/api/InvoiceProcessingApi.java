...
public class InvoiceProcessingApi {
     ...
     * @param invoiceData Invoice data in JSON format.              Two formats accepted:             1. **Classic format**: Complete FactureFacturX structure (all fields)             2. **Simplified format** (🆕 P0.1): Minimal structure with auto-enrichment              Format is detected automatically!              (required)
    ...
    private okhttp3.Call generateInvoiceApiV1ProcessingGenerateInvoicePostValidateBeforeCall(@javax.annotation.Nonnull String invoiceData, @javax.annotation.Nullable APIProfile profile, @javax.annotation.Nullable OutputFormat outputFormat, @javax.annotation.Nullable Boolean autoEnrich, @javax.annotation.Nullable File sourcePdf, final ApiCallback _callback) throws ApiException {
        ...
        return generateInvoiceApiV1ProcessingGenerateInvoicePostCall(invoiceData, profile, outputFormat, autoEnrich, sourcePdf, _callback);
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call signPdfAsyncApiV1ProcessingSignPdfAsyncPostValidateBeforeCall(@javax.annotation.Nonnull File pdfFile, @javax.annotation.Nullable String reason, @javax.annotation.Nullable String location, @javax.annotation.Nullable String contact, @javax.annotation.Nullable String fieldName, @javax.annotation.Nullable Boolean usePadesLt, @javax.annotation.Nullable Boolean useTimestamp, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pdfFile' is set
        if (pdfFile == null) {
        ...
        return signPdfAsyncApiV1ProcessingSignPdfAsyncPostCall(pdfFile, reason, location, contact, fieldName, usePadesLt, useTimestamp, _callback);
     ...
     */
    public Object signPdfAsyncApiV1ProcessingSignPdfAsyncPost(@javax.annotation.Nonnull File pdfFile, @javax.annotation.Nullable String reason, @javax.annotation.Nullable String location, @javax.annotation.Nullable String contact, @javax.annotation.Nullable String fieldName, @javax.annotation.Nullable Boolean usePadesLt, @javax.annotation.Nullable Boolean useTimestamp) throws ApiException {
        ApiResponse<Object> localVarResp = signPdfAsyncApiV1ProcessingSignPdfAsyncPostWithHttpInfo(pdfFile, reason, location, contact, fieldName, usePadesLt, useTimestamp);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> signPdfAsyncApiV1ProcessingSignPdfAsyncPostWithHttpInfo(@javax.annotation.Nonnull File pdfFile, @javax.annotation.Nullable String reason, @javax.annotation.Nullable String location, @javax.annotation.Nullable String contact, @javax.annotation.Nullable String fieldName, @javax.annotation.Nullable Boolean usePadesLt, @javax.annotation.Nullable Boolean useTimestamp) throws ApiException {
        okhttp3.Call localVarCall = signPdfAsyncApiV1ProcessingSignPdfAsyncPostValidateBeforeCall(pdfFile, reason, location, contact, fieldName, usePadesLt, useTimestamp, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call signPdfAsyncApiV1ProcessingSignPdfAsyncPostAsync(@javax.annotation.Nonnull File pdfFile, @javax.annotation.Nullable String reason, @javax.annotation.Nullable String location, @javax.annotation.Nullable String contact, @javax.annotation.Nullable String fieldName, @javax.annotation.Nullable Boolean usePadesLt, @javax.annotation.Nullable Boolean useTimestamp, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = signPdfAsyncApiV1ProcessingSignPdfAsyncPostValidateBeforeCall(pdfFile, reason, location, contact, fieldName, usePadesLt, useTimestamp, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call submitCompleteInvoiceAsyncApiV1ProcessingInvoicesSubmitCompleteAsyncPostCall(@javax.annotation.Nonnull SubmitCompleteInvoiceRequest submitCompleteInvoiceRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call submitCompleteInvoiceAsyncApiV1ProcessingInvoicesSubmitCompleteAsyncPostValidateBeforeCall(@javax.annotation.Nonnull SubmitCompleteInvoiceRequest submitCompleteInvoiceRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'submitCompleteInvoiceRequest' is set
        if (submitCompleteInvoiceRequest == null) {
        ...
        return submitCompleteInvoiceAsyncApiV1ProcessingInvoicesSubmitCompleteAsyncPostCall(submitCompleteInvoiceRequest, _callback);
     ...
     */
    public TaskResponse submitCompleteInvoiceAsyncApiV1ProcessingInvoicesSubmitCompleteAsyncPost(@javax.annotation.Nonnull SubmitCompleteInvoiceRequest submitCompleteInvoiceRequest) throws ApiException {
        ApiResponse<TaskResponse> localVarResp = submitCompleteInvoiceAsyncApiV1ProcessingInvoicesSubmitCompleteAsyncPostWithHttpInfo(submitCompleteInvoiceRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TaskResponse> submitCompleteInvoiceAsyncApiV1ProcessingInvoicesSubmitCompleteAsyncPostWithHttpInfo(@javax.annotation.Nonnull SubmitCompleteInvoiceRequest submitCompleteInvoiceRequest) throws ApiException {
        okhttp3.Call localVarCall = submitCompleteInvoiceAsyncApiV1ProcessingInvoicesSubmitCompleteAsyncPostValidateBeforeCall(submitCompleteInvoiceRequest, null);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call submitCompleteInvoiceAsyncApiV1ProcessingInvoicesSubmitCompleteAsyncPostAsync(@javax.annotation.Nonnull SubmitCompleteInvoiceRequest submitCompleteInvoiceRequest, final ApiCallback<TaskResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = submitCompleteInvoiceAsyncApiV1ProcessingInvoicesSubmitCompleteAsyncPostValidateBeforeCall(submitCompleteInvoiceRequest, _callback);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call validateFacturxPdfApiV1ProcessingValidateFacturxPdfPostValidateBeforeCall(@javax.annotation.Nonnull File pdfFile, @javax.annotation.Nullable APIProfile profile, @javax.annotation.Nullable Boolean useVerapdf, final ApiCallback _callback) throws ApiException {
        ...
        return validateFacturxPdfApiV1ProcessingValidateFacturxPdfPostCall(pdfFile, profile, useVerapdf, _callback);
    ...
    private okhttp3.Call validateFacturxPdfAsyncApiV1ProcessingValidateFacturxAsyncPostValidateBeforeCall(@javax.annotation.Nonnull File pdfFile, @javax.annotation.Nullable APIProfile profile, @javax.annotation.Nullable Boolean useVerapdf, final ApiCallback _callback) throws ApiException {
        ...
        return validateFacturxPdfAsyncApiV1ProcessingValidateFacturxAsyncPostCall(pdfFile, profile, useVerapdf, _callback);
    ...
    private okhttp3.Call validateXmlApiV1ProcessingValidateXmlPostValidateBeforeCall(@javax.annotation.Nonnull File xmlFile, @javax.annotation.Nullable APIProfile profile, final ApiCallback _callback) throws ApiException {
        ...
        return validateXmlApiV1ProcessingValidateXmlPostCall(xmlFile, profile, _callback);
