...
public class ReferencesApiTest {
     ...
     */
    @Test
    public void getVatexCodesApiV1ReferencesVatexCodesGetTest() throws ApiException {
        String category = null;
        VATEXCodesResponse response = api.getVatexCodesApiV1ReferencesVatexCodesGet(category);
