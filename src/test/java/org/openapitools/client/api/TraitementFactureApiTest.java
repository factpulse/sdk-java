...
/**
 * API tests for TraitementFactureApi
 */
@Disabled
public class TraitementFactureApiTest {

    private final TraitementFactureApi api = new TraitementFactureApi();
     ...
     */
    @Test
    public void genererFactureApiV1TraitementGenererFacturePostTest() throws ApiException {
        String donneesFacture = null;
        ProfilAPI profil = null;
        FormatSortie formatSortie = null;
        Boolean autoEnrichir = null;
        File sourcePdf = null;
        ReponseTache response = api.genererFactureApiV1TraitementGenererFacturePost(donneesFacture, profil, formatSortie, autoEnrichir, sourcePdf);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void obtenirStatutTacheApiV1TraitementTachesIdTacheStatutGetTest() throws ApiException {
        String idTache = null;
        StatutTache response = api.obtenirStatutTacheApiV1TraitementTachesIdTacheStatutGet(idTache);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void soumettreFactureCompleteApiV1TraitementFacturesSoumettreCompletePostTest() throws ApiException {
        SoumettreFactureCompleteRequest soumettreFactureCompleteRequest = null;
        SoumettreFactureCompleteResponse response = api.soumettreFactureCompleteApiV1TraitementFacturesSoumettreCompletePost(soumettreFactureCompleteRequest);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void soumettreFactureCompleteAsyncApiV1TraitementFacturesSoumettreCompleteAsyncPostTest() throws ApiException {
        SoumettreFactureCompleteRequest soumettreFactureCompleteRequest = null;
        ReponseTache response = api.soumettreFactureCompleteAsyncApiV1TraitementFacturesSoumettreCompleteAsyncPost(soumettreFactureCompleteRequest);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void validerPdfFacturxApiV1TraitementValiderPdfFacturxPostTest() throws ApiException {
        File fichierPdf = null;
        ProfilAPI profil = null;
        Boolean useVerapdf = null;
        ResultatValidationPDFAPI response = api.validerPdfFacturxApiV1TraitementValiderPdfFacturxPost(fichierPdf, profil, useVerapdf);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void validerPdfFacturxAsyncApiV1TraitementValiderFacturxAsyncPostTest() throws ApiException {
        File fichierPdf = null;
        ProfilAPI profil = null;
        Boolean useVerapdf = null;
        ReponseTache response = api.validerPdfFacturxAsyncApiV1TraitementValiderFacturxAsyncPost(fichierPdf, profil, useVerapdf);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void validerXmlApiV1TraitementValiderXmlPostTest() throws ApiException {
        File fichierXml = null;
        ProfilAPI profil = null;
        ReponseValidationSucces response = api.validerXmlApiV1TraitementValiderXmlPost(fichierXml, profil);
        // TODO: test validations
    }
