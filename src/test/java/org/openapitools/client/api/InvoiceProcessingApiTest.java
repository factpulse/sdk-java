...
/**
 * API tests for InvoiceProcessingApi
 */
@Disabled
public class InvoiceProcessingApiTest {

    private final InvoiceProcessingApi api = new InvoiceProcessingApi();
    ...
    public void generateInvoiceApiV1ProcessingGenerateInvoicePostTest() throws ApiException {
        ...
        TaskResponse response = api.generateInvoiceApiV1ProcessingGenerateInvoicePost(invoiceData, profile, outputFormat, autoEnrich, sourcePdf, callbackUrl, webhookMode, skipBrFr);
     ...
     */
    @Test
    public void generateTestCertificateApiV1ProcessingGenerateTestCertificatePostTest() throws ApiException {
        GenerateCertificateRequest generateCertificateRequest = null;
        GenerateCertificateResponse response = api.generateTestCertificateApiV1ProcessingGenerateTestCertificatePost(generateCertificateRequest);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void signPdfApiV1ProcessingSignPdfPostTest() throws ApiException {
        File pdfFile = null;
        String reason = null;
        ...
        Object response = api.signPdfApiV1ProcessingSignPdfPost(pdfFile, reason, location, contact, fieldName, usePadesLt, useTimestamp);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void signPdfAsyncApiV1ProcessingSignPdfAsyncPostTest() throws ApiException {
        File pdfFile = null;
        String callbackUrl = null;
        String webhookMode = null;
        String reason = null;
        ...
        Boolean usePadesLt = null;
        Boolean useTimestamp = null;
        Object response = api.signPdfAsyncApiV1ProcessingSignPdfAsyncPost(pdfFile, callbackUrl, webhookMode, reason, location, contact, fieldName, usePadesLt, useTimestamp);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void submitCompleteInvoiceApiV1ProcessingInvoicesSubmitCompletePostTest() throws ApiException {
        SubmitCompleteInvoiceRequest submitCompleteInvoiceRequest = null;
        SubmitCompleteInvoiceResponse response = api.submitCompleteInvoiceApiV1ProcessingInvoicesSubmitCompletePost(submitCompleteInvoiceRequest);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void submitCompleteInvoiceAsyncApiV1ProcessingInvoicesSubmitCompleteAsyncPostTest() throws ApiException {
        SubmitCompleteInvoiceRequest submitCompleteInvoiceRequest = null;
        String callbackUrl = null;
        String webhookMode = null;
        TaskResponse response = api.submitCompleteInvoiceAsyncApiV1ProcessingInvoicesSubmitCompleteAsyncPost(submitCompleteInvoiceRequest, callbackUrl, webhookMode);
        // TODO: test validations
    }
    ...
    public void validateFacturxPdfApiV1ProcessingValidateFacturxPdfPostTest() throws ApiException {
        ...
        Boolean skipBrFr = null;
        PDFValidationResultAPI response = api.validateFacturxPdfApiV1ProcessingValidateFacturxPdfPost(pdfFile, profile, useVerapdf, skipBrFr);
        // TODO: test validations
    }
    ...
    public void validateFacturxPdfAsyncApiV1ProcessingValidateFacturxAsyncPostTest() throws ApiException {
        ...
        String callbackUrl = null;
        String webhookMode = null;
        TaskResponse response = api.validateFacturxPdfAsyncApiV1ProcessingValidateFacturxAsyncPost(pdfFile, profile, useVerapdf, callbackUrl, webhookMode);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void validatePdfSignatureEndpointApiV1ProcessingValidatePdfSignaturePostTest() throws ApiException {
        File pdfFile = null;
        Object response = api.validatePdfSignatureEndpointApiV1ProcessingValidatePdfSignaturePost(pdfFile);
        // TODO: test validations
    }
