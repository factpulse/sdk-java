...
/**
 * API tests for ProcessingEndpointsUnifisApi
 */
@Disabled
public class ProcessingEndpointsUnifisApiTest {

    private final ProcessingEndpointsUnifisApi api = new ProcessingEndpointsUnifisApi();
