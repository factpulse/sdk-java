...
/**
 * API tests for UtilisateurApi
 */
@Disabled
public class UtilisateurApiTest {

    private final UtilisateurApi api = new UtilisateurApi();
     ...
     */
    @Test
    public void obtenirInfosUtilisateurApiV1MoiGetTest() throws ApiException {
        Object response = api.obtenirInfosUtilisateurApiV1MoiGet();
