...
/**
 * Model tests for InvoiceReferences
 */
public class InvoiceReferencesTest {
    private final InvoiceReferences model = new InvoiceReferences();
