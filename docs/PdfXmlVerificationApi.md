...
import org.openapitools.client.api.PdfXmlVerificationApi;
...
> TaskResponse verifyPdfAsyncApiV1VerificationVerifyAsyncPost(pdfFile, forceOcr)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      TaskResponse result = apiInstance.verifyPdfAsyncApiV1VerificationVerifyAsyncPost(pdfFile, forceOcr);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PdfXmlVerificationApi#verifyPdfAsyncApiV1VerificationVerifyAsyncPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> TaskResponse verifyPdfAsyncApiV1VerificationVerifyAsyncPost_0(pdfFile, forceOcr)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean forceOcr = false; // Boolean | Force OCR usage even if PDF contains native text
    try {
      TaskResponse result = apiInstance.verifyPdfAsyncApiV1VerificationVerifyAsyncPost_0(pdfFile, forceOcr);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PdfXmlVerificationApi#verifyPdfAsyncApiV1VerificationVerifyAsyncPost_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling PdfXmlVerificationApi#verifyPdfSyncApiV1VerificationVerifyPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    File pdfFile = new File("/path/to/file"); // File | Factur-X PDF file to verify
    try {
      VerificationSuccessResponse result = apiInstance.verifyPdfSyncApiV1VerificationVerifyPost_0(pdfFile);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PdfXmlVerificationApi#verifyPdfSyncApiV1VerificationVerifyPost_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
