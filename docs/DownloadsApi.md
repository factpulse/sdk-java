...
> Object checkFileApiV1DownloadDownloadIdHead_0(downloadId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String downloadId = "downloadId_example"; // String | 
    try {
      Object result = apiInstance.checkFileApiV1DownloadDownloadIdHead_0(downloadId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DownloadsApi#checkFileApiV1DownloadDownloadIdHead_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> Object downloadFileApiV1DownloadDownloadIdGet_0(downloadId, deleteAfter)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean deleteAfter = false; // Boolean | If true, delete the file after download (one-time download)
    try {
      Object result = apiInstance.downloadFileApiV1DownloadDownloadIdGet_0(downloadId, deleteAfter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DownloadsApi#downloadFileApiV1DownloadDownloadIdGet_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
